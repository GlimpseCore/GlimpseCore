...
namespace GlimpseCore.Agent.Internal.Inspectors
{
    public partial class WebDiagnosticsListener
    {
        private static IDictionary<string, MiddlewareInfo> MiddlewarePackageStartsWithMap = new Dictionary<string, MiddlewareInfo> {
            ...
            { "GlimpseCore.Agent.Inspectors.DefaultInspectorFunctionManager+", new MiddlewareInfo { ShortName = "GlimpseCore Agent Extension", PackageName = "GlimpseCore Agent" } }
        };

        private static IDictionary<string, MiddlewareInfo> MiddlewarePackageMap = new Dictionary<string, MiddlewareInfo>
        {
            { "GlimpseCore.Agent.GlimpseCoreAgentMiddleware", new MiddlewareInfo { ShortName = "AgentMiddleware", PackageName = "GlimpseCore Agent" } },
            { "GlimpseCore.Server.GlimpseCoreServerMiddleware", new MiddlewareInfo { ShortName = "ServerMiddleware", PackageName = "GlimpseCore Server" } },
