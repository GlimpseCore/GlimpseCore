...
namespace GlimpseCore.Agent.Internal.Inspectors
{
    public class UserInspector : Inspector
    {
        ...
        private const string GlimpseCoreCookie = ".GlimpseCore.Session"; // TODO: Move this somewhere configurable
        ...
        {
            var cookieValue = context.Request.Cookies[GlimpseCoreCookie];
            ...
            if (string.IsNullOrEmpty(cookieValue))
            {
                ...
                {
                    context.Response.Cookies.Append(GlimpseCoreCookie, _context.RequestId.ToString("N"));
                }
            }
        }
        ...
        public override void After(HttpContext context)
        {
            ...
            {
                isAnonymous = true;
                userId = (string)context.Request.Cookies[GlimpseCoreCookie] ?? _context.RequestId.ToString("N");
            }
