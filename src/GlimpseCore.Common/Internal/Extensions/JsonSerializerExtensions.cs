...
using GuidConverter = GlimpseCore.Common.Internal.Serialization.GuidConverter;
...
namespace GlimpseCore.Internal.Extensions
{
    public static class JsonSerializerExtensions
    {
        ...
        public static void Configure(this JsonSerializer jsonSerializer)
        {
            ...
            jsonSerializer.Converters.Add(new Common.Internal.Serialization.GuidConverter());
        }
    }
}